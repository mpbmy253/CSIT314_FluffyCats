...
class CCViewPaper extends React.Component {
    constructor() {
        super();
        this.state = {
            tableData: [],
        ...
        return (
            <div className="flex items-left justify-center w-screen min-h-screen bg-gray-500 ">
                <div className="container my-8 px-6">
                    <h2 className="text-3xl font-bold mb-6 text-white mt-20">VIEW AVAILABLE SUBMITTED PAPERS</h2>
                                    ...
                                    <table className="min-w-full text-center">
                                        <thead className="border-b bg-gray-800">
                                            <tr>
                                                ...
                                                <th className="text-sm font-lg text-white px-6 py-4">Reviewer</th>
                                                <th className="text-sm font-lg text-white px-6 py-4">View Paper Content</th>
                                            </tr>
                                        </thead>
                                                ...
                                                if (row.paperData.IsClaimed == false)
                                                    return (
                                                        <tr className="bg-white border-b-2 border-black hover:bg-gray-300">
                                                            ...
                                                            <td className="text-sm text-gray-900 font-semibold px-6 py-4 whitespace-nowrap">{row.paperData.ClaimedBy}</td>
                                                            <button id={index + 1}
                                                                className="bg-teal-600 text-white my-3 px-6 py-2 rounded-lg hover:bg-teal-800 "
                                                                onClick={this.checkContent}>
                                                                <Link to='/conferencechair-vpccontent'>
                                                                    View Content
                                                                </Link>
                                                            </button>
                                                        </tr>
