...
import ToViewReviewerData from "../Controller/ToViewReviewerData";
import { useNavigate } from "react-router-dom";

const SystemAdminAfterLoginReviewers = () => {
                        ...
                        <aside className="w-64" aria-label="Sidebar">
                            <div className="container overflow-y-auto py-4 px-3 bg-gray-800 h-screen">
                                ...
                                <ul className="space-y-2">
                                    ...
                                    <li>
                                        <button onClick={goReviewerTab} className="flex items-center p-2 pr-32 text-base font-normal text-gray-900 rounded-lg bg-gray-100">
                                            <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 group-hover:text-white"
                                                fill="currentColor"
                                                viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="container mx-2">
                                <div className="w-full max-w-full p-2 mx-auto">
                                    <div className="flex flex-wrap -mx-3">
                                        <ToViewReviewerData></ToViewReviewerData>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default SystemAdminAfterLoginReviewers