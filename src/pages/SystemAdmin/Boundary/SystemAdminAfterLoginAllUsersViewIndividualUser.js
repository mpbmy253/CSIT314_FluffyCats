...
const SystemAdminAfterLoginAllUsersViewIndividualUser = () => {
	getUsers();
						...
						<div className="w-full h-full pt-2 ">
							<div className="container mx-2">
								<div className="w-full max-w-full p-6 mx-auto">
									<h2 className="text-2xl text-black">User Information</h2>
...
export default SystemAdminAfterLoginAllUsersViewIndividualUser;
