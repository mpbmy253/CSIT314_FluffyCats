...
import ToViewAllUserData from "../Controller/ToViewAllUserData";

const SystemAdminAfterLoginAllUsers = () => {
    const navigate = useNavigate();

    // Function to create new user
    function createNewUserAccount() {
        navigate("/new-user-account") // Direct to SystemAdminAfterLoginAllUsersCreateNewUserAccount.js
    }

    // Function to search based on username
                        ...
                        <div className="w-full h-full ">
                            <div className="container mx-2 ">
                                <div className="w-full max-w-full p-2 mx-auto">
                                    <input className="w-full h-12 rounded mb-2 text-xl px-8 shadow-2xl"
                                        type="search" placeholder="Search username">
                                    </input>
                                    <nav className="flex">
                                        <button
                                            onClick={createNewUserAccount}
                                            className="no-underline text-white py-1 px-4 font-medium mr-3 bg-lime-500 hover:bg-lime-800">Create new user
                                        </button>
                                        <button
                                            onClick={searchUsername}
                                            className="no-underline text-white py-3 px-4 font-medium ml-auto bg-sky-400 hover:bg-sky-800" >Search
                                        </button>
                                    </nav>
                                    <div className='flex flex-wrap -mx-3 mb-2'>
                                        <ToViewAllUserData></ToViewAllUserData>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default SystemAdminAfterLoginAllUsers